...
ping -w 2 -c 1 build.wireguard.com >/dev/null 2>&1 || { mkdir "net/wireguard/"; touch "net/wireguard/.noconnectivity"; echo "No internet detected, skipping WireGuard update." >&2; exit 0; }
